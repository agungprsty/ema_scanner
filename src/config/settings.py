...
BITUNIX_DEFAULT_LEVERAGE = int(os.getenv("BITUNIX_DEFAULT_LEVERAGE", "5"))
BITUNIX_BLUECHIP_LEVERAGE = int(os.getenv("BITUNIX_BLUECHIP_LEVERAGE", "10"))
BITUNIX_BLUECHIP_SYMBOLS = ["BTCUSDT", "ETHUSDT", "XAUUSDT"]
BITUNIX_AUTO_SL = os.getenv("BITUNIX_AUTO_SL", "true").lower() in ("true", "1", "yes")
